  ...
  ["vendors"], {
    ...
    qFKp: function (e, t, n) {
      ...
      (function (t) {
        ...
        }, u.isMobile = (r = /Android/i.test(navigator.userAgent), o = /BlackBerry/i.test(navigator.userAgent), i = /iPhone|iPad|iPod/i.test(navigator.userAgent), s = /Opera Mini/i.test(navigator.userAgent), a = r || o || i || s, {
          Android: function () {
            return r
          },
          BlackBerry: function () {
    ...
    udhc: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", {
        ...
        return r(t, e), t.prototype.addNamespaces = function (e) {
          ...
          var s, a = [e, t];
          e.indexOf(".") > -1 && (r = n, n = t, t = (a = e.split("."))[1]), this.addNamespaces(t), s = u.getPath(this.data, a) || {},
            r ? u.deepExtend(s, n, i) : s = o({}, s, n), u.setPath(this.data, a, s), this.emit("added", e, t, n)
    ...
    xL1m: function (e, t, n) {
      ...
      ! function (e) {
        if (document.createElement("canvas") && document.createElement("canvas").getContext) {
          ...
          if (!(c <= 1)) e.hidpiCanvasRatio = c, e.hidpiCanvasUnpatched = !1, r = CanvasRenderingContext2D.prototype,
            a = function (e, t) {
