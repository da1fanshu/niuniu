<template>
	<view class="content">
		...
		<view class="reset">
			...
			<view class="item clear" style="margin-top: 59upx;">
				<view class="fl">
					<image src="/static/reg_email.png" style="width: 24upx; height: 16upx;" mode=""></image>
				</view>
				<input class="fr" v-model="account" type="text" placeholder="请输入手机号或者邮箱" />
			</view>
			...
			<view class="item imgCode clear">
				...
				<input class="fr" type="number" v-model="phoneCode" maxlength="6" placeholder="验证码" />
			</view>
			<view class="item clear">
				<view class="fl">
					<image src="/static/login_pwd.png" style="width: 24upx; height: 26upx;" mode=""></image>
				</view>
				<input class="fr" type="password" v-model="newPwd" placeholder="输入新密码(最小六个字符)" />
			</view>
			<view class="item clear">
				<view class="fl">
					<image src="/static/login_pwd.png" style="width: 24upx; height: 26upx;" mode=""></image>
				</view>
				<input class="fr" type="password" v-model="cenPwd" placeholder="再次输入密码" />
			</view>
	...
	export default {
		...
		methods: {
			...
			submits() {
				...
				let num = '';
				if (REG_EMAIL.test(this.account)) {} else {
					num = '86';
				}
				this.loading = true;
				service.resetLogin({
