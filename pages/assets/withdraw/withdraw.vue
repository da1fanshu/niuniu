	...
	<view class="content">
		<view class="withdraw">
			<view class="withdraw_nav">
				<button class="ll" :class="type == 'ordinary' ? 'active' : ''" @click="type = 'ordinary'">普通提币</button>
				<button class="rr" :class="type == 'stand' ? 'active' : ''" @click="type = 'stand'">站内转币</button>
			</view>
			...
			<view class="withdraw_tpis">
				<view style="color: #488FD3;">禁止向{{ coin }}地址充值除{{ coin }}之外的资产，任何充入{{ coin }}地址的非{{ coin }}资产将不可找回</view>
