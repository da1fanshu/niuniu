        ...
        <view class="common_list_main">
          ...
          <view id="withdraw">
            <view class="c_l_m_title">
              ...
              <text style="max-width: 246upx;min-width: 246upx; padding-right: 12upx;">转出到</text>
              <text style="padding: 0 12upx;">数量</text>
              <text style="padding: 0 12upx;">区块费</text>
              <text style="max-width: 62upx;">状态</text>
            </view>
            <view class="c_l_m_list">
      ...
      <view class="common_list">
        ...
        <view class="common_list_main">
          ...
          <view id="transfer">
            ...
            <view class="c_l_m_list">
              <view class="item" v-for="(item, index) in []" :key="index">
                <text style="max-width: 170upx; min-width: 170upx;">2019-05-20 13:14</text>
                <text>币币账户</text>
                <text>划入账户</text>
                <text>225.0000</text>
                <text style="max-width: 62upx;" class="suc">已完成</text>
              </view>
            </view>
            <view class="common_list_page"><uni-pagination total="10" :showIcon="true"></uni-pagination></view>
          </view>
        </view>
      </view>
    </view>
